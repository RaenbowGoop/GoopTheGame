...
public class GoopObject : ItemObject, System.IEquatable<GoopObject>
{
    ...
    [JsonProperty] public int goopAttackRange;
    [JsonProperty] public int goopKnockbackLimit;
    [JsonProperty] public string goopTargetType; //Single target vs Multi target attacks

    //Status Effects
    [JsonProperty] public int freezeChance;  //chance to freeze enemy's animation for a period of time
    [JsonProperty] public int shatterChance; //chance to decrease enemy's attack for a period of time

    //Extra Damage Effects
    [JsonProperty] public int criticalHitChance; //chance to increase damage dealt to enemy
